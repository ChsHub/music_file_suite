...
converter_command = 'D:\\Making\\Python\\music_file_suite\\lib\\ffmpeg\\bin\\ffmpeg.exe -i "input" -codec:a libmp3lame -q:a 0 -ar 44100 -map_metadata 0 -id3v2_version 3  "output"'
# 48000
# -af "volume=10dB"
# -af "volume=1.5"
